	...
	String role=(String)hs.getAttribute("role");
	 %>
	   <td align="right" valign="bottom" colspan=2>
                ...
                <b>[ <%if(role.equals("admin")){%><a href="./AdminHome.jsp"><%} else if(role.equals("Tester")){%><a href="./TesterHome.jsp?cat=Tester"><%} else if(role.equals("Developer")){%><a href="./DeveloperHome.jsp?cat=Developer&uname=<%=uname%>"><%}else if(role.equals("HRManager")){%><a href="./ManagerHome.jsp?cat=HrManager&uname=<%=uname%>"><%} %><font color="#FBC61">home</font></a> ]</b>&nbsp;
